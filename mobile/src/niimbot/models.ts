...
// Ordered most-specific first so detectModel matches "b18"/"b21" before "b1".
export const NIIMBOT_MODELS: NiimbotModel[] = [
  { id: "b18", label: "Niimbot B18", matchNames: ["b18"], widthPx: 240, verified: false },
  { id: "b21", label: "Niimbot B21", matchNames: ["b21"], widthPx: 384, verified: false },
  { id: "b1", label: "Niimbot B1", matchNames: ["b1"], widthPx: 384, verified: true },
  { id: "d11", label: "Niimbot D11", matchNames: ["d11"], widthPx: 96, verified: false },
  { id: "d110", label: "Niimbot D110", matchNames: ["d110"], widthPx: 96, verified: false },
];
